...
ch0_data  = 1000 ; ch1_data  = 0; ch2_data  = 0; ch3_data  = 0; ch4_data  = 0; \
...
while True:
    ...
    #print('\n before bit inversion, array in int: ', end = '')
    #for i in range(len(array)):
        #print( array[i], '', end = '')
    #print('\n before bit inversion, array in binary: ', end = '')
    #for i in range(len(array)):
        #print( format(array[i], '08b'), '', end = '')
    
    # invert all bits to make it same as receiver output
    #for i in range(len(array)):
        #array[i] = np.ubyte(~ array[i])
        
    #print('\n after bit inversion, array in int: ', end = '')
    #for i in range(len(array)):
        #print( array[i], '', end = '')
    #print('\n after bit inversion, array in binary: ', end = '')
    #for i in range(len(array)):
        #print( format(array[i], '08b'), '', end = '')
    ...
    time.sleep(0.2) # send command sendArray every 3 seconds for test
