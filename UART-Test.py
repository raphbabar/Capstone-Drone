...
def frameProcess(   ch0_data, ch1_data, ch2_data, ch3_data, ch4_data, \
...
try:
    ch0_data  = 1300 ; ch1_data  = 1200; ch2_data  = 1200; ch3_data  = 1200; ch4_data  = 1200; \
    ch5_data  = 1200; ch6_data  = 1200; ch7_data  = 1200; ch8_data  = 1200; ch9_data  = 1200; \
    ch10_data = 1200; ch11_data = 1200; ch12_data = 1200; ch13_data = 1200; ch14_data = 1200; \
    ch15_data = 1200
    
    #ch0_data = 994
    #print("before ch0 is ",ch0_data)
    ch0_data = sendCommand(ch0_data)
    #print("after ch0 is ",ch0_data)
